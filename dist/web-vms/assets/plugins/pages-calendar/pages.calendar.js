...
(function(factory) {
    ...
    var PagesCalendar = function(element, options) {
        ...
        this.$html +='<div class="calendar-header" style="display:none">'
            ...
            render : function(){
                ...
                for (var i = 1; i <= Calendar.daysOfMonth; i++) {
                    ...
                    function _construcWeekday(){
                        ...
                        Calendar.content += '<div class="day"><span data-date=' + date.format(Calendar.settings.ui.week.day.format) + '>' + i + '</span></div>';
                        Calendar.content += '</div>';
                        Calendar.content += '</div>';
                    }
            ...
            */
            _bindEvents:function(){
                ...
                $(document).on("click", "body:not(.pending) .date-selector",function(e) {
                    ...
                    calendar.date = parseInt($(this).children('.week-date').children('.day').children('span').attr('data-date'));
