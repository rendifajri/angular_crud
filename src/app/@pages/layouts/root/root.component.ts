...
export class RootLayout implements OnInit, OnDestroy {
  ...
  _layout;
  menuLinks;
  pic = 'assets/img/visitor_temp_photo.png'
  ...
  constructor(public toggler:pagesToggleService,private router: Router,private CookieService: CookieService,http: HttpClient) {
